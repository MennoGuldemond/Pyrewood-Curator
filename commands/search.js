...
const DriveReader = require('../utils/drive-reader');
const MessageBuilder = require('../utils/message-builder');

const hordeImage = new AttachmentBuilder('./assets/Horde.png');
const allianceImage = new AttachmentBuilder('./assets/Alliance.png');

module.exports = {
  data: new SlashCommandBuilder()
    .setName('search')
    .setDescription('Returns the a list of crafters for a given recipe')
        ...
        .then(async (data) => {
          ...
          if (matches.length === 1) {
            ...
            return await interaction.reply({
              embeds: [embed],
              files: [isHorde ? hordeImage : allianceImage],
            });
